...
## 좌표계변환이란?
선형시스템 __Ax__=__b__ 가 있을 때, 행렬__A__를 좌표계로 보고 벡터__x__와 __b__를 좌표값으로 보는 방법입니다.

예를들어,
![](https://images.velog.io/images/hojp7874/post/4b9d1c67-8ee0-4153-90a5-2d9955a126fc/image.png)
위와 같은 식에서 __b__는 앞에 항등행렬을 곱한것과 같습니다.
