...
__귀무가설__: __전체 학생들의 키 평균 = 선택된 학생의 키 평균__일 확률
__대립가설__: __전체 학생들의 키 평균 > 선택된 학생의 키 평균__일 확률
### 가설검정의 절차
1. __H0, H1__을 설정한다.
2. 유의수준 __α__(확률이 낮다는 기준점)를 설정한다.
3. __검정통계량__을 계산한다.
4. __기각역__ 또는 __임계값__ 계산
	__기각역이란?__![](https://images.velog.io/images/hojp7874/post/b04fb776-bbca-49c2-82d3-894688d07f5e/image.png)
5. 주어진 데이터로부터 __유의성 판정__
